                ...
                <div class="row">
					...
					<div class="col-12">
                        <div class="card">
                            ...
                            <a class="btn btn-primary" href="#"><i class="fa fa-plus"> Add User</i></a>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
													...
													<div class="d-flex">
														...
														<a href="{{ url('/user/delete', $user->id) }}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>
